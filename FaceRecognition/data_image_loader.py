...
def load_caltech_face_dataset(image_dir):
...
def load_caltech_face_train_dataset():
    return load_caltech_face_dataset(CALTECH_FACES_TRAIN_DIR)


def load_caltech_face_test_dataset():
    return load_caltech_face_dataset(CALTECH_FACES_TEST_DIR)

# images, labels = load_caltech_face_dataset()
# print(len(images))
# print(len(labels))
